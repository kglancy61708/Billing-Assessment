  ...
  try {
    ...
    res.json({
      ...
      fields: {
        ...
        custbodycustom_del_location: so.custbodycustom_del_location || '',
...
app.post('/api/salesorder/recreate', async (req, res) => {
  try {
    ...
    const payload = {
      ...
      ...(fields.custbodycustom_del_location ? { custbodycustom_del_location: fields.custbodycustom_del_location } : {}),
